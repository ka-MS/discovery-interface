...
DB 본체·Instance의 엔진별 분류와 Device 관계는 [Database CI 수집 설계](design/ci/databaseinstance.md),
업무 Application·WEB/WAS runtime·기타 설치 SW는 [Application CI 수집 설계](design/ci/application.md)에 있다.
