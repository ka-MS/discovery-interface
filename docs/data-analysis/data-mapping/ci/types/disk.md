...
> 구현: [DiskCiImport](../../../../../src/main/java/com/itmsg/device42/pipeline/d42maximo/ci/disk/DiskCiImport.java) · [DiskCiQuery](../../../../../src/main/java/com/itmsg/device42/source/device42/ci/disk/DiskCiQuery.java) · [DiskCiMapper](../../../../../src/main/java/com/itmsg/device42/pipeline/d42maximo/ci/disk/DiskCiMapper.java) · [ActCiWriter](../../../../../src/main/java/com/itmsg/device42/target/maximo/ci/ActCiWriter.java) · 상태: 본체·스펙 적재 구현 및 자동 테스트 완료. Computer→Disk 관계 저장도 구현됨. 과거 적재 이력·승격 검증 범위는 [ACTCIRELATION](../actcirelation.md) 참조.
