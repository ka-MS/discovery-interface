...
> Target: MAXIMO.DPAMADAPTER · 구현: [DpamAdapterImport](../../../../src/main/java/com/itmsg/device42/pipeline/d42maximo/conversion/adapter/DpamAdapterImport.java) · [AdapterModelsQuery](../../../../src/main/java/com/itmsg/device42/source/device42/conversion/adapter/AdapterModelsQuery.java) · [DpamAdapterWriter](../../../../src/main/java/com/itmsg/device42/target/maximo/conversion/DpamAdapterWriter.java)
...
| COMPUTER 대상 | `MediaAdapterQuery` 와 동일한 `MaximoSourcePolicy.ASSET_COMPUTER` | 자식이 기록할 값만 등록한다 |
