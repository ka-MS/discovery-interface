...
> 관측: 2026-09-15 · Maximo BLUDB / MAXIMO, 읽기 전용.
...
- ACTCIRELATIONSEQ가 존재하며 증가폭은 1000이다. 실제 NEXT VALUE를 소비하지 않고 메타데이터만 확인했다.
...
규칙에 맞는 방향을 처음부터 생성하고 SWAPPED=0을 쓰는 안은 설계안이며,
현재 설치 버전에서의 표시·승격 동작은 아직 쓰기 검증하지 않았다.
