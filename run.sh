...
required=(
  MAXIMO_JDBC_URL MAXIMO_JDBC_USERNAME MAXIMO_JDBC_PASSWORD MAXIMO_JDBC_SCHEMA
  DEVICE42_REST_BASE_URL DEVICE42_REST_USERNAME DEVICE42_REST_PASSWORD
  DEVICE42_TRUSTSTORE DEVICE42_TRUSTSTORE_PASSWORD
  DEVICE42_JDBC_URL DEVICE42_JDBC_USERNAME DEVICE42_JDBC_PASSWORD DEVICE42_JDBC_SCHEMA
)
missing=()
