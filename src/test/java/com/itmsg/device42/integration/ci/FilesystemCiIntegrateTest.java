...
class FilesystemCiIntegrateTest {
    private JdbcTemplate jdbc;
    private FilesystemCiIntegrate integration;
    ...
    void sourceQueryExcludesContainerAndVirtualFilesystems() throws Exception {
        ...
        new FilesystemCiIntegrate(factory, new ActCiWriter(jdbc), new CiSpecMapper()).getData(0, 10);
