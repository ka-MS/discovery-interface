...
class DiskCiIntegrateTest {
    private JdbcTemplate jdbc;
    private DiskCiIntegrate integration;
    ...
    void missingClassificationSkipsEveryDisk() {
        ...
        var mapped = integration.mapData(List.of(disk(9, new BigDecimal("500"), "GB", "SER")), definitionLoader.load());
