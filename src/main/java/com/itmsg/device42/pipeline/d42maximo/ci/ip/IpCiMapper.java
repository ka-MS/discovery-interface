package com.itmsg.device42.pipeline.d42maximo.ci.ip;
...
import com.itmsg.device42.source.device42.ci.ip.IpSource;
...
import com.itmsg.device42.pipeline.d42maximo.ci.mapping.IpSpec;
        ...
        for (IpSource source : data) {
            try {
                ...
                ActCiUpsert actCi = new ActCiUpsert(
                        MaximoCiIdentity.of(Device42Entity.IPADDRESS, source.ipAddressPk()), source.ipAddress(), definition.classStructureId(),
