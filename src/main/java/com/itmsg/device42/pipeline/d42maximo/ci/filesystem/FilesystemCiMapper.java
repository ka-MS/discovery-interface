package com.itmsg.device42.pipeline.d42maximo.ci.filesystem;
...
import com.itmsg.device42.source.device42.ci.filesystem.FilesystemSource;
...
import com.itmsg.device42.pipeline.d42maximo.ci.mapping.FilesystemSpec;
        ...
        for (FilesystemSource source : data) {
            try {
                ...
                ActCiUpsert actCi = new ActCiUpsert(
                        MaximoCiIdentity.of(Device42Entity.MOUNTPOINT, source.mountPointPk()), source.mountPoint(), definition.classStructureId(),
