...
import com.itmsg.device42.pipeline.d42maximo.ci.mapping.DatabaseInstanceSpec;
        ...
        for (DatabaseInstanceSource source : data) {
            try {
                ...
                ActCiUpsert actCi = new ActCiUpsert(
                        MaximoCiIdentity.of(Device42Entity.DATABASEINSTANCE, source.databaseInstancePk()), source.name(),
