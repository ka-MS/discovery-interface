...
import com.itmsg.device42.maximo.asset.DpaNetAdapterWriter;
...
@Component("dpaNetAdapterIntegrate")
@Order(7)
public class NetAdapterImport implements AssetIntegrationTask {
