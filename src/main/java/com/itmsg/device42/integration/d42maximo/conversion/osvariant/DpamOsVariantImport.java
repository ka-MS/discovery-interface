...
import com.itmsg.device42.dto.maximo.conversion.DpamOsVariantUpsert;
...
@Component("dpamOsVariantIntegrate")
@Order(4)
public class DpamOsVariantImport implements ConversionIntegrationTask {
