...
import com.itmsg.device42.maximo.conversion.DpamAdapterWriter;
...
@Component("dpamAdapterIntegrate")
@Order(7)
public class DpamAdapterImport implements ConversionIntegrationTask {
